...
set CLASSPATH=%CLASSPATH%;target\lib\esper-4.2.0.jar
set CLASSPATH=%CLASSPATH%;target\lib\esperio-csv-4.2.0.jar
set CLASSPATH=%CLASSPATH%;target\lib\esperio-http-4.2.0.jar
